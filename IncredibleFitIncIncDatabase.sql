...
alter table AIM
   drop constraint FK_AIM_IS_FROM_USER
/
...
alter table EXERCISE_SPORT
   drop constraint FK_EXERCISE_CONTAINS_EXERCISE
/
...
alter table FITNESSLEVEL
   drop constraint FK_FITNESSL_OWNS_USER
/

alter table INGREDIENT
   drop constraint FK_INGREDIE_BELONGS2_QUANTITY
/

alter table QUANTITYPRICE
   drop constraint FK_QUANTITY_BELONGS_INGREDIE
/
...
alter table RECIPE_APPOINTMENT
   drop constraint FK_RECIPE_A_CONTAINS2_RECIPE
/
...
alter table "USER"
   drop constraint FK_USER_IS_FROM2_AIM
/

alter table "USER"
   drop constraint FK_USER_OWNS2_FITNESSL
/
...
/* Index: IS_FROM_FK                                            */
/*==============================================================*/
create index IS_FROM_FK on AIM (
   EMAIL ASC
)
/
...
/* Index: CONTAINS3_FK                                          */
/*==============================================================*/
create index CONTAINS3_FK on EXERCISE_CATEGORY (
   EXE_ID ASC
)
/
...
/* Index: CONTAINS_FK                                           */
/*==============================================================*/
create index CONTAINS_FK on EXERCISE_SPORT (
   ID ASC
)
/
...
/* Index: OWNS_FK                                               */
/*==============================================================*/
create index OWNS_FK on FITNESSLEVEL (
   EMAIL ASC
)
/
...
/* Index: BELONGS2_FK                                           */
/*==============================================================*/
create index BELONGS2_FK on INGREDIENT (
   QUA_ID ASC
)
/
...
/* Index: BELONGS_FK                                            */
/*==============================================================*/
create index BELONGS_FK on QUANTITYPRICE (
   ING_ID ASC
)
/
...
/* Index: CONTAINS2_FK                                          */
/*==============================================================*/
create index CONTAINS2_FK on RECIPE_APPOINTMENT (
   ID ASC
)
/
...
/* Index: IS_FROM2_FK                                           */
/*==============================================================*/
create index IS_FROM2_FK on "USER" (
   AIM_ID ASC
)
/
...
create table USER_RECIPE (
   EMAIL                VARCHAR2(50)          not null,
   ID                   NUMBER(6)             not null,
   constraint PK_USER_RECIPE primary key (EMAIL, ID)
)
/
...
create table USER_SPORT (
   EMAIL                VARCHAR2(50)          not null,
   ID                   NUMBER(6)             not null,
   constraint PK_USER_SPORT primary key (EMAIL, ID)
)
/
...
create table USER_TRAINING_PLAN (
   EMAIL                VARCHAR2(50)          not null,
   ID                   NUMBER(6)             not null,
   constraint PK_USER_TRAINING_PLAN primary key (EMAIL, ID)
)
/
...
alter table AIM
   add constraint FK_AIM_IS_FROM_USER foreign key (EMAIL)
...
alter table APPOINTMENT
   add constraint FK_APPOINTM_USER_APPO_USER foreign key (EMAIL)
      references "USER" (EMAIL)
/
...
alter table EXERCISE_SPORT
   add constraint FK_EXERCISE_CONTAINS_EXERCISE foreign key (ID)
      references EXERCISE (ID)
/
...
alter table FITNESSLEVEL
   add constraint FK_FITNESSL_OWNS_USER foreign key (EMAIL)
      references "USER" (EMAIL)
/

alter table INGREDIENT
   add constraint FK_INGREDIE_BELONGS2_QUANTITY foreign key (QUA_ID)
      references QUANTITYPRICE (ID)
/

alter table QUANTITYPRICE
   add constraint FK_QUANTITY_BELONGS_INGREDIE foreign key (ING_ID)
...
alter table RECIPE
   add constraint FK_RECIPE_USER_RECI_USER foreign key (EMAIL)
      references "USER" (EMAIL)
/

alter table RECIPE_APPOINTMENT
   add constraint FK_RECIPE_A_CONTAINS2_RECIPE foreign key (ID)
      references RECIPE (ID)
/
...
alter table "USER"
   add constraint FK_USER_IS_FROM2_AIM foreign key (AIM_ID)
      references AIM (ID)
/

alter table "USER"
   add constraint FK_USER_OWNS2_FITNESSL foreign key (FIT_ID)
...
alter table USER_RECIPE
   add constraint FK_USER_REC_IS_CALLED_USER foreign key (EMAIL)
      references "USER" (EMAIL)
/

alter table USER_SPORT
   add constraint FK_USER_SPO_IS_PRACTI_USER foreign key (EMAIL)
      references "USER" (EMAIL)
/
...
alter table USER_TRAINING_PLAN
   add constraint FK_USER_TRA_IS_CALLED_USER foreign key (EMAIL)
      references "USER" (EMAIL)
/
